...
const OpenChallenge = () => {
  return (
    <div className="wrapper">
      <div id="left">
        <p className="heading">
          live open <span>challenge</span>
        </p>
        {/* timeline */}
        <div className="timeline">
          <div className="upper">
            <p>
              Copy open challenge from <span>ravan3p</span>
            </p>
            <li>2 minutes ago</li>
          </div>
          <div className="lower">
      ...
      <div id="right">
        ...
        <div className="price_content">
          <div className="search">
            ...
            <input type="text" placeholder="Search Battle" />
          </div>
